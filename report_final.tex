...
noiseless setting.
Recovery rises steeply below $N\approx500$ and levels off near
45--46 atoms above $N=1500$, matching the trend of paper Figure~6.
K-SVD consistently matches or exceeds MOD at every training-set
size, confirming that the SVD atom update is more sample-efficient
than the global pseudoinverse step.
...
$\sigma$ & Noisy & K-SVD & NLM & BM3D \\
\midrule
10 & XX.XX & XX.XX & XX.XX & \textbf{XX.XX} \\
20 & XX.XX & XX.XX & XX.XX & \textbf{XX.XX} \\
25 & XX.XX & XX.XX & XX.XX & \textbf{XX.XX} \\
30 & XX.XX & XX.XX & XX.XX & \textbf{XX.XX} \\
\bottomrule
\end{tabular}
\end{table}
...
image, which differs in content and texture from Camera Man.
The relative ordering K-SVD $\approx$ NLM $<$ BM3D is preserved,
indicating that the findings are not image-specific.
K-SVD's image-adaptive dictionary generalises well to unseen
natural images without retraining.
